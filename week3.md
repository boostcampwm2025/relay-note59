...
#### 선택 이유: 미션을 진행하면서 요구사항 파악 및 계획조차 어떻게 세워야 할지 막연할때가 있다. AI와 같이 계획을 짠다면 막연한 계획을 좀 더 수월하게 짤 수 있을 것 같다고 생각하였고, 세워진 계획을 어떻게 수행할지도 AI를 활용한다면 체계적으로 계획을 수행할 수 있을 것 같아 선택하였습니다.
</details>
